 ...
 * HR Dashboard Page
 *
 * Main dashboard for HR users showing:
 * - Summary statistics (employees, check-ins, leaves, anomalies)
 * - Quick action cards for HR modules (without system settings)
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                ...
                <p className="font-medium text-navy-900">Attendance Overview</p>
