...
import { MessageSquare, Wifi, WifiOff, ArrowLeft } from 'lucide-react';
...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-silver-50">
      {/* Header with back button */}
      <header className="bg-white border-b border-silver-200 px-4 py-3 flex items-center gap-4">
        <button
          onClick={() => router.push('/dashboard')}
          className="p-2 hover:bg-silver-100 rounded-lg transition-colors"
        >
          <ArrowLeft className="h-5 w-5 text-silver-600" />
        </button>
        <h1 className="font-semibold text-lg text-navy-900">Messages</h1>
      </header>

      <div className="flex-1 flex bg-white rounded-xl border border-silver-200 overflow-hidden m-4">
