...
export const usePresenceStore = create<PresenceState>((set, get) => ({
  ...
  disconnect: () => {
    ...
    if (socket) {
      socket.disconnect();
      set({ socket: null, isConnected: false, _cleanupFns: [] });
    }
  },
 ...
 * Filters by status and department if set
 */
...
/**
 * Selector for unique departments from team members
 */
