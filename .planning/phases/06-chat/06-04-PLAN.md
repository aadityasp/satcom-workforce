...
**Test 6: Role-Based Access (CHAT-06)**
- Log in as Employee → verify /chat accessible and functional
- Log in as Manager → verify /chat accessible and functional
- Log in as HR → verify /chat accessible and functional
- Log in as SuperAdmin → verify /chat accessible and functional
